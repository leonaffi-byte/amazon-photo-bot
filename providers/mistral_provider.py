"""
Mistral vision provider — Pixtral 12B via Mistral's OpenAI-compatible API.

Pricing (per 1M tokens):
  pixtral-12b-2409: $0.10 input, $0.10 output
  ~$0.0001 per photo
"""
...
_PRICING: dict[str, tuple[float, float]] = {
    "pixtral-12b-2409": (0.0001, 0.0001),
}
...
class MistralProvider(VisionProvider):
    ...
    def __init__(self, api_key: str, model: str = "pixtral-12b-2409"):
        ...
        rates = _PRICING.get(model, (0.0001, 0.0001))
        self.cost_per_1k_input_tokens  = rates[0]
        self.cost_per_1k_output_tokens = rates[1]
        self.cost_per_image            = 0.0
        self._display_name = _DISPLAY_NAMES.get(model, model)

    @property
    def full_name(self) -> str:
        return f"mistral/{self._display_name}"
