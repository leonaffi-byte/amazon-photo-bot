"""
Fireworks AI vision provider — Qwen2.5-VL via Fireworks' OpenAI-compatible API.

Pricing (per 1M tokens):
  Qwen2.5-VL-72B-Instruct: $0.90 input, $0.90 output
  ~$0.001 per photo
"""
...
class FireworksProvider(VisionProvider):
    ...
    def __init__(self, api_key: str, model: str = "accounts/fireworks/models/qwen2-vl-72b-instruct"):
        ...
        rates = _PRICING.get(model, (0.0009, 0.0009))
    ...
    def full_name(self) -> str:
        return f"fireworks/{self._display_name}"
